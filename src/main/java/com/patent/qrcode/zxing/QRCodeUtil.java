package com.patent.qrcode.zxing;
...
public class QRCodeUtil {
    ...
    public static Bitmap createQRCodeBitmap(@Nullable String content, int size){
        return createQRCodeBitmap(content, size, "UTF-8", "H", "2", Color.BLACK, Color.WHITE, null, null, 0F);
    }
    ...
    public static Bitmap createQRCodeBitmap(@Nullable String content, int size, @ColorInt int color_black, @ColorInt int color_white){
        return createQRCodeBitmap(content, size, "UTF-8", "H", "2", color_black, color_white, null, null, 0F);
    }
    ...
    public static Bitmap createQRCodeBitmap(String content, int size, @Nullable Bitmap logoBitmap, float logoPercent){
        return createQRCodeBitmap(content, size, "UTF-8", "H", "2", Color.BLACK, Color.WHITE, null, logoBitmap, logoPercent);
    }
    ...
    public static Bitmap createQRCodeBitmap(String content, int size, Bitmap targetBitmap){
        return createQRCodeBitmap(content, size, "UTF-8", "H", "2", Color.BLACK, Color.WHITE, targetBitmap, null, 0F);
    }
